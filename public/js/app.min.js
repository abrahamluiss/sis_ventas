...
function onClickReniec() {
    ...
    fetch(`https://apiperu.dev/api/dni/${dni}`, {
        headers: {
            ...
            "Authorization": "Bearer 1b9fcbbf5d35f80c7b08c03aae1b5bd1aaf7598f5fa4267e3784cb5d7ac891e1"
        }
    })
    .then(response => response.json())
    .then(json => { dataNames(json.data) });
}

function dataNames(data){
    const nameComplete = document.getElementById("name");
    var name = data['nombre_completo'];
    nameComplete.value = name;
}
